<?php
/**
 * Báo cáo & Thống kê trả hàng nội bộ
 *
 * Trang dashboard hiển thị tổng quan trả hàng giữa các shop
 *
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
        <div class="d-flex flex-column justify-content-center">
            ...
            <p class="text-muted mb-0">
                ...
                <span>Báo cáo trả hàng nội bộ</span>
            </p>
        </div>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <small class="text-muted">Phiếu trả nội bộ</small>
                        <div class="mt-2">
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <small class="text-muted">Tổng SP trả</small>
                        <div class="mt-2">
                            <span class="text-info" id="statProductsExported">0 trả</span> |
                            <span class="text-success" id="statProductsImported">0 nhận</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-8 mb-4">
                <div class="card h-100">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="card-title mb-0">Xu hướng trả hàng</h5>
                    </div>
                    <div class="card-body">
...
jQuery(document).ready(function($) {
    ...
    function loadReportData() {
        ...
        $.ajax({
            ...
            type: 'POST',
            data: {
                action: 'tgs_return_get_report_data',
                nonce: nonce,
                period: period
            },
    ...
    function renderReport(data) {
        ...
        $('#statProductsExported').text((data.summary.products_exported || 0) + ' trả');
        $('#statProductsImported').text((data.summary.products_imported || 0) + ' nhận');
        ...
        renderRecentReturns(data.recent || []);
    }
    ...
    function renderEmptyReport() {
        ...
        $('#statProductsExported').text('0 trả');
        $('#statProductsImported').text('0 nhận');
    ...
    function renderExportedShops(shops) {
        if (!shops || shops.length === 0) {
            $('#exportedShopsTable').html('<tr><td colspan="4" class="text-center text-muted py-4">Chưa trả cho shop nào</td></tr>');
    ...
    function renderRecentReturns(returns) {
        if (!returns || returns.length === 0) {
            $('#recentReturnsTable').html('<tr><td colspan="7" class="text-center text-muted py-4">Chưa có hoạt động nào</td></tr>');
            return;
        }
        ...
        returns.forEach(function(t) {
            ...
            const typeLabel = t.type === 'export' ? 'Trả đi' : 'Nhận về';
            const statusBadge = t.status === 'approved'
                ? '<span class="badge bg-success">Đã duyệt</span>'
                : '<span class="badge bg-warning">Chờ duyệt</span>';

            const detailUrl = t.type === 'export'
                ? '<?php echo admin_url('admin.php?page=tgs-shop-management&view=ticket-return-export-detail'); ?>&id=' + t.ledger_id
                : '<?php echo admin_url('admin.php?page=tgs-shop-management&view=ticket-return-import-detail'); ?>&id=' + t.ledger_id;
