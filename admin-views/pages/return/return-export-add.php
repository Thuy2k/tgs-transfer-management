<?php
/**
 * Return Export Add - Tạo phiếu trả hàng nội bộ
 *
 * Shop con tạo phiếu trả hàng lên shop mẹ
 *
...
$auto_ledger_code = 'THN-' . date('ymd') . '-' . strtoupper(substr(uniqid(), -4));
...
<div class="app-return-export">
    <!-- Breadcrumb & Header -->
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
        <div class="d-flex flex-column justify-content-center">
            <h4 class="mb-1">Trả hàng nội bộ</h4>
            <p class="text-muted mb-0">
                <a href="<?php echo admin_url('admin.php?page=tgs-shop-management'); ?>">Dashboard</a>
                <span class="mx-1">/</span>
                <a href="<?php echo admin_url('admin.php?page=tgs-shop-management&view=ticket-return-exports'); ?>">Phiếu trả nội bộ</a>
                <span class="mx-1">/</span>
                <span>Tạo mới</span>
            </p>
        </div>
        <div>
            <a href="<?php echo admin_url('admin.php?page=tgs-shop-management&view=ticket-return-exports'); ?>" class="btn btn-outline-secondary">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-3 mb-3">
                                <label class="form-label" for="destinationBlogId">
                                    Shop nhận trả <span class="text-danger">*</span>
                                </label>
                                <select class="form-select" id="destinationBlogId" name="destination_blog_id" required>
                                    <option value="">-- Chọn shop nhận trả --</option>
                                ...
                                <small class="text-muted">Chọn shop sẽ nhận hàng trả</small>
                            </div>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control" id="transferNote" name="transfer_note" rows="2"
                                          placeholder="Nhập ghi chú cho phiếu trả..."></textarea>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
                        <h5 class="card-title mb-0">
                            <i class="bx bx-package me-2"></i>Sản phẩm trả
                        </h5>
                ...
                <div class="alert alert-info mt-3">
                    ...
                    <ul class="mb-0 ps-3">
                        ...
                        <li><strong>Sản phẩm không tracking:</strong> Nhập số lượng cần trả</li>
                        <li>Sản phẩm chưa có ở shop nhận sẽ được <strong>đồng bộ tự động</strong></li>
                        <li>Phiếu trả cần được <strong>duyệt</strong> trước khi shop nhận có thể nhận hàng trả</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body py-3">
                        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                            ...
                            <button type="submit" class="btn btn-primary btn-lg" id="btnSubmit">
                                <i class="bx bx-save me-1"></i> Tạo phiếu trả
                            </button>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Chọn sản phẩm để trả</h5>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                ...
                <p id="syncCheckMessage">Đang kiểm tra sản phẩm tại shop nhận...</p>
...
(function($) {
    ...
    function loadProducts() {
        $.ajax({
            ...
            type: 'POST',
            data: {
                action: 'tgs_return_get_products',
                nonce: CONFIG.nonce
            },
    ...
    function checkProductSync() {
        ...
        $('#syncCheckMessage').text('Đang kiểm tra sản phẩm tại shop nhận...');
        ...
        $.ajax({
            ...
            type: 'POST',
            data: {
                action: 'tgs_return_check_products_sync',
                nonce: CONFIG.nonce,
    ...
    function handleSyncCheckResult(data) {
        ...
        synced.forEach(function(productId) {
            $(`tr[data-product-id="${productId}"] .sync-status`)
                .html('<i class="bx bx-check-circle text-success" title="Đã có tại shop nhận"></i>');
        });
        ...
        if (needSync.length === 0) {
            ...
            showAlert('success', 'Tất cả sản phẩm đã có tại shop nhận');
            return;
        }
        ...
        $('#syncCheckMessage').html(`
            <div class="alert alert-warning mb-0">
                <strong>${needSync.length} sản phẩm</strong> chưa có tại shop nhận.<br>
    ...
    function handleFormSubmit(e) {
        ...
        if (!destinationBlogId) {
            showAlert('danger', 'Vui lòng chọn shop nhận trả');
            return;
        }
        ...
        $.ajax({
            ...
            type: 'POST',
            data: {
                action: 'tgs_return_create_export',
                nonce: CONFIG.nonce,
                destination_blog_id: destinationBlogId,
            ...
            success: function(response) {
                if (response.success) {
                    showAlert('success', 'Tạo phiếu trả thành công! Đang chuyển hướng...');
                    setTimeout(function() {
                        window.location.href = response.data.redirect_url ||
                            '<?php echo admin_url("admin.php?page=tgs-shop-management&view=ticket-return-exports"); ?>';
                    }, 1500);
                } else {
                    showAlert('danger', response.data.message || 'Lỗi tạo phiếu trả');
                    $('#btnSubmit').prop('disabled', false).html('<i class="bx bx-save me-1"></i> Tạo phiếu trả');
                }
            },
            error: function() {
                showAlert('danger', 'Lỗi kết nối server');
